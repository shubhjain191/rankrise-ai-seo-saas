...
export function OverallScoreCard({ seoReport }: OverallScoreCardProps) {
  ...
  // Calculate the actual score for linear logic
  ...
  // Determine linear color based on score
  const getScoreGradient = (score: number) => {
    if (score >= 70) {
      return "bg-linear-to-r from-gray-400 to-green-600";
    } else if (score >= 50) {
      return "bg-linear-to-r from-gray-400 to-yellow-500";
    } else {
      return "bg-linear-to-r from-gray-400 to-red-500";
    }
  };
