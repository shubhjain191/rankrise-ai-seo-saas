...
export function KeyMetricsGrid({ seoReport }: KeyMetricsGridProps) {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
      {/* Keywords Found */}
      <Card className="relative overflow-hidden border bg-linear-to-br from-blue-50 to-cyan-50 dark:from-blue-950/30 dark:to-cyan-950/30 group hover:shadow-md transition-all duration-300">
      ...
      {/* Total Sources */}
      <Card className="relative overflow-hidden border bg-linear-to-br from-green-50 to-emerald-50 dark:from-green-950/30 dark:to-emerald-950/30 group hover:shadow-md transition-all duration-300">
      ...
      {/* Unique Domains */}
      <Card className="relative overflow-hidden border bg-linear-to-br from-orange-50 to-amber-50 dark:from-orange-950/30 dark:to-amber-950/30 group hover:shadow-md transition-all duration-300">
      ...
      {/* Competitors */}
      <Card className="relative overflow-hidden border bg-linear-to-br from-purple-50 to-violet-50 dark:from-purple-950/30 dark:to-violet-950/30 group hover:shadow-md transition-all duration-300">
