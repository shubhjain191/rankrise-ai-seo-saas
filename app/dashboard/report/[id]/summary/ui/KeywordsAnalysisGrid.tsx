  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 lg:gap-8 min-w-0">
      ...
      <Card className="border bg-linear-to-br from-card to-card/95 min-w-0 w-full">
        <CardHeader className="pb-4 sm:pb-6">
          <div className="flex items-start sm:items-center gap-3">
            <div className="p-2 sm:p-3 rounded-full bg-linear-to-br from-blue-100 to-cyan-100 dark:from-blue-900/50 dark:to-cyan-900/50 shrink-0">
            ...
            {(seoReport?.keywords?.content_keywords || []).map(
              (keyword, index) => {
                const intentConfig = {
                  informational: {
                    bgClass:
                      "bg-linear-to-br from-blue-50 to-cyan-50 dark:from-blue-950/30 dark:to-cyan-950/30",
                ...
                const config = intentConfig[
                  ...
                  bgClass:
                    "bg-linear-to-br from-gray-50 to-slate-50 dark:from-gray-950/30 dark:to-slate-950/30",
                    ...
                    <div className="flex items-start gap-3 sm:gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-2 sm:gap-3 mb-3">
                          <h4 className="font-bold text-base sm:text-lg leading-tight wrap-break-words">
                            {keyword.keyword}
                          </h4>
                          <Badge
                        ...
                        {keyword.evidence && keyword.evidence.length > 0 && (
                          <div className="space-y-3 max-h-40 overflow-y-auto">
                            ...
                            {keyword.evidence.map((evidence, evidenceIndex) => (
                              ...
                              >
                                <p className="text-sm text-muted-foreground mb-3 italic leading-relaxed wrap-break-words">
                                ...
                                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
                                  ...
                                  <Badge
                                    variant="outline"
                                    className="text-xs bg-white/80 dark:bg-black/20 self-start sm:self-center shrink-0"
                                  >
      ...
      <Card className="border bg-linear-to-br from-card to-card/95 min-w-0 w-full">
        <CardHeader className="pb-4 sm:pb-6">
          <div className="flex items-start sm:items-center gap-3">
            <div className="p-2 sm:p-3 rounded-full bg-linear-to-br from-orange-100 to-amber-100 dark:from-orange-900/50 dark:to-amber-900/50 shrink-0">
        ...
        <CardContent className="min-w-0">
          <div className="grid gap-4 sm:gap-6">
            {(seoReport?.keywords?.keyword_themes || []).map((theme, index) => {
              const themeConfig = {
                bgClass:
                  "bg-linear-to-br from-orange-50 to-amber-50 dark:from-orange-950/30 dark:to-amber-950/30",
              ...
              return (
                ...
                >
                  <div className="flex items-start gap-3 sm:gap-4">
                    <div
                      className={`p-2 rounded-full bg-white/80 dark:bg-black/20 ${themeConfig.iconClass} shrink-0`}
                    >
                        ...
                        <div className="flex flex-wrap gap-1.5 sm:gap-2">
                          {theme.keywords.map((kw, kwIndex) => (
                            <Badge
                              key={kwIndex}
                              variant="secondary"
                              className="text-xs bg-white/60 dark:bg-black/20 text-orange-700 dark:text-orange-300 wrap-break-words max-w-full"
                            >
                              {kw}
                            </Badge>
                          ))}
