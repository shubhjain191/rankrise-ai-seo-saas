...
export function AIChatUpsellCard() {
  return (
    <Card className="border-none shadow-2xl bg-linear-to-br from-indigo-500/10 via-purple-500/8 to-pink-500/10 relative overflow-hidden group hover:shadow-indigo-500/20 transition-all duration-500">
      {/* Decorative elements */}
      <div className="absolute top-0 right-0 w-40 h-40 bg-linear-to-br from-indigo-400/20 to-purple-400/20 rounded-full -translate-y-20 translate-x-20 group-hover:scale-110 transition-transform duration-700" />
      <div className="absolute bottom-0 left-0 w-32 h-32 bg-linear-to-tr from-purple-400/15 to-pink-400/15 rounded-full translate-y-16 -translate-x-16 group-hover:scale-110 transition-transform duration-700" />
          ...
          <div className="space-y-6">
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                <div className="p-3 rounded-full bg-linear-to-br from-indigo-500 to-purple-600 shadow-lg">
              ...
              <h2 className="text-3xl lg:text-4xl font-bold tracking-tight bg-linear-to-r from-indigo-600 via-purple-600 to-pink-600 bg-clip-text text-transparent">
                AI SEO Assistant
              </h2>
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-2">
              <Button
                asChild
                className="bg-linear-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white border-0 shadow-lg hover:shadow-indigo-500/25 transition-all duration-300 hover:scale-105 group px-8 py-6 text-base h-auto"
              >
                <Link href="/pricing">
          ...
          <div className="text-center lg:text-right relative">
            <div className="relative inline-block">
              ...
              <div className="relative">
                ...
                <div className="bg-linear-to-r from-indigo-600 to-purple-600 text-white rounded-2xl rounded-br-md shadow-lg p-4 max-w-xs ml-auto">
                  <p className="text-sm">
              ...
              {/* Floating elements */}
              <div className="absolute -top-4 -right-4 w-12 h-12 bg-linear-to-br from-yellow-400 to-orange-500 rounded-full flex items-center justify-center shadow-lg animate-bounce">
                <Sparkles className="w-6 h-6 text-white" />
              </div>

              <div className="absolute -bottom-2 -left-4 w-8 h-8 bg-linear-to-br from-green-400 to-blue-500 rounded-full flex items-center justify-center shadow-lg animate-pulse">
