        ...
        <div className="grid gap-6">
          {(seoReport?.recommendations || []).map((rec, index) => {
            const priorityConfig = {
              high: {
                bgClass:
                  "bg-linear-to-br from-red-50 to-pink-50 dark:from-red-950/30 dark:to-pink-950/30",
              ...
              medium: {
                bgClass:
                  "bg-linear-to-br from-amber-50 to-yellow-50 dark:from-amber-950/30 dark:to-yellow-950/30",
