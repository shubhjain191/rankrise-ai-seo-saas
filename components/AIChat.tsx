    ...
    <>
      ...
      {isExpanded && (
        <div className="fixed bottom-20 right-6 z-50 w-[500px] h-[600px] bg-white rounded-3xl shadow-2xl border border-gray-100 flex flex-col overflow-hidden">
          {/* Header */}
          <div className="flex items-center justify-between p-5 bg-linear-to-r from-indigo-600 to-purple-600 text-white rounded-t-3xl">
          ...
          <div className="p-5 border-t border-gray-100 bg-gray-50/50">
            <form onSubmit={handleSubmit} className="flex gap-3">
              ...
              <Button
                ...
                className="h-11 px-4 bg-linear-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 rounded-xl shadow-sm"
              >
